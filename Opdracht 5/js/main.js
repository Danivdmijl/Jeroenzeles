...
fetch("/data/trellies.json").then(
    ...
    function(data){
        ...
        for(let i = 0; i < data.activities.length; i++){
            ...
            let toBeAddedContainer = document.createElement("div");
            toBeAddedContainer.classList.add("tasks__container");
            toBeAddedLi.appendChild(toBeAddedContainer);
            ...
            toBeAddedContainer.appendChild(toBeAddedAuthor);
        }
    }
)